...
- Quick-reply (bắt buộc khi có lựa chọn): Mỗi khi bạn đưa ra 2 hoặc 3–4 phương án để user chọn (kể cả "would you like to explore X, Y, or Z?" hoặc "is it for A, B, or C?"), kết thúc tin nhắn bằng đúng một dòng: QUICKREPLY: Nhãn1 | Nhãn2 | Nhãn3. Không kết thúc bằng câu nhắc Partner — câu cuối phải là câu hỏi có lựa chọn, ngay sau đó là dòng QUICKREPLY. Nhãn ngắn (2–5 từ). Ví dụ: "explore these areas in detail" / "discuss how solutions support your goals" / "talk to Partner" → QUICKREPLY: Explore in detail | Discuss solutions | Talk to Partner. Xác nhận ngôn ngữ: QUICKREPLY: Yes, use English | No, keep Vietnamese. Nút phải xuất hiện mỗi khi có 2+ lựa chọn.
`;
